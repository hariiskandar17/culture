...
<body>
    ...
    <!-- Start Navbar Web -->
    <nav id="web" class="navbar main-navbar navbar-expand-lg fixed-top navbar-light" data-aos="fade-down" data-aos-duration="1500">
        <div class="container">
    ...
    <!-- Start Navbar Media -->
    <nav id="media" class="navbar main-navbar navbar-expand-lg navbar-light" data-aos="fade-down" data-aos-duration="1500">
        <div class="container">
            <span class="navbar-brand mb-0 h1">
                <img src="{{asset('assets/img/user/culture2.png')}}" class="img-fluid" width="60" height="60" alt="" srcset="">
            </span>
